...
public class CheckDescriptionMessageHandler extends CheckExerciseMessageHandler {
    ...
    public CheckDescriptionMessageHandler(DataLayerObject dataLayer, ExerciseProvider exerciseProvider, UserModeSettings userModeSettings) {
    ...
    protected String getCurrentExerciseFlashcardAttributeCheckValue(Long chatId) {
        ...
        return currentExercise.description();
    }
}
