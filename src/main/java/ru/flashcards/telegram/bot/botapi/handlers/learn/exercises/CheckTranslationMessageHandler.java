...
public class CheckTranslationMessageHandler extends CheckExerciseMessageHandler {
    ...
    public CheckTranslationMessageHandler(DataLayerObject dataLayer, ExerciseProvider exerciseProvider, UserModeSettings userModeSettings) {
    ...
    protected String getCurrentExerciseFlashcardAttributeCheckValue(Long chatId) {
        ...
        return currentExercise.translation();
    }
}
